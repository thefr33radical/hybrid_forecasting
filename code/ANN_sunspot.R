...
NNTAR = nnetar(window(data,end=1953),size =4,p=4,decay=0.1, maxit=250000,scale.inputs=TRUE)
plot(forecast(NNTAR,h=35))
predicted = forecast(NNTAR,h=35)
predicted
plot(predicted)
summary(NNTAR)
# Finde MSE
...
test_set = c(window(data,start=1954))
test_set
pred
